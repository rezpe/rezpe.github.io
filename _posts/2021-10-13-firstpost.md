...
>
> **Update 2026-01-20:** Improved readability with section headings and added images.
...
![The Mandalorian's StageCraft LED wall virtual production environment](/assets/images/2021-10-16-future-of-cinema/mandalorian.png){: width="90%" }
*Image source: [Ars Technica](https://arstechnica.com/gaming/2020/02/the-mandalorian-was-shot-on-a-holodeck-esque-set-with-unreal-engine-video-shows/)*
...
![Irradiation film production using motion capture and real-time Unreal Engine rendering](/assets/images/2021-10-16-future-of-cinema/irradiation.png){: width="90%" }
*Image source: [Irradiation on Vimeo](https://vimeo.com/585797977?fl=pl&fe=vl)*
...
![MediaPipe BlazePose AI-powered pose estimation from a single camera](/assets/images/2021-10-16-future-of-cinema/mediapipe-blazepose.gif){: width="90%" }
*Image source: [TensorFlow Blog - 3D Pose Detection with MediaPipe BlazePose](https://blog.tensorflow.org/2021/08/3d-pose-detection-with-mediapipe-blazepose-ghum-tfjs.html)*

## Democratizing Creation Tools
...
![Unreal Engine Blueprint visual scripting makes game development accessible](/assets/images/2021-10-16-future-of-cinema/unreal.png){: width="90%" }
*Image source: [Unreal Engine - Introduction to Blueprints](https://www.unrealengine.com/es-ES/blog/introduction-to-blueprints)*
